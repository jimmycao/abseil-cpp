...
/**
 * In fact, Channel is deque with 'capacity and block_size'.
 * in case of producer / consumer, Channel can be write and read by multiple-threads.
 * As a matter of fact, deque is operated throught push_back and pop_front with lock.
 * Channel provides put/get a item or read/write a bunch of data.
 */
template<class T>
class ChannelObject {
public:
